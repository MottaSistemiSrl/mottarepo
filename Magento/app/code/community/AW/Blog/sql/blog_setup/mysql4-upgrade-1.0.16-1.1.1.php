...
CREATE TABLE IF NOT EXISTS  {$this->getTable('blog/related')} (
...
$installer->run("
    ALTER TABLE {$this->getTable('blog/blog')} ADD `vetrina` TINYINT( 1 ) NOT NULL DEFAULT 0 ;
");

$installer->run("
    ALTER TABLE {$this->getTable('blog/blog')} ADD `data_evento` DATE  DEFAULT NULL ;
");

$installer->run("
    ALTER TABLE {$this->getTable('blog/blog')} ADD `luogo_evento` VARCHAR(255)  DEFAULT NULL ;
");

$installer->run("
    ALTER TABLE {$this->getTable('blog/blog')} ADD `slider_home` TINYINT(1)  DEFAULT 0 ;
");
