...
class Bitbull_BancaSellaPro_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    public function log($msg) {
        Mage::log($msg, null, 'Bitbull_BancaSellaPro.log', Mage::getStoreConfig('payment/gestpaypro/log'));
    }
    ...
    function getRedirectUrlToPayment(Mage_Sales_Model_Order $order){
        ...
        $crypt = Mage::helper('bitbull_bancasellapro/crypt');
        $stringEncrypt = $crypt->getEncryptStringByOrder($order);

        $method = $order->getPayment()->getMethodInstance();

        if($method instanceof Bitbull_BancaSellaPro_Model_Gestpay){
    ...
    function getGestPayJs(){
        $method = Mage::getModel('bitbull_bancasellapro/gestpay');
        $url = null;
