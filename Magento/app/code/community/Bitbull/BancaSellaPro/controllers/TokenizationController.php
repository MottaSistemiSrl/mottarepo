...
class Bitbull_BancaSellaPro_TokenizationController extends Mage_Core_Controller_Front_Action {
    ...
    protected function _initProfile()
    {
        ...
        if (!$profile->getId() || $profile->getCustomerId()!= $this->_session->getCustomerId() || $profile->getMethodCode()!= Bitbull_BancaSellaPro_Model_Gestpay::METHOD_CODE ) {
    ...
    public function resultAction(){
        ...
        $profile = Mage::helper('bitbull_bancasellapro/recurringprofile')->getProfileIdByOrder(Mage::registry('bitbull_bancasellapro_order'));
