    ...
    public function collect(Mage_Sales_Model_Quote_Address $address)
    {
	    ...
	    //$pointsAmount = Mage::helper('rewardpoints/data')->convertPointsToMoney($creditPoints, $address->getCustomerId());
            if ($address->getCustomerId()){
                $pointsAmount = Mage::helper('rewardpoints/data')->convertPointsToMoney($creditPoints, $address->getCustomerId(), $address->getQuote());
            } elseif ($address->getQuote()->getCustomerId()) {
                $pointsAmount = Mage::helper('rewardpoints/data')->convertPointsToMoney($creditPoints, $address->getQuote()->getCustomerId(), $address->getQuote());
            } else {
