    ...
    public function forgotpasswordAction()
    {
        ...
        if (!empty($email) && !empty($params)) {
            ...
            if (Zend_Validate::is($email, 'EmailAddress')) {
                ...
                $this->_getSession()
                    ->addSuccess(Mage::helper('adminhtml')->__('Se esiste un account associato a %s riceverai un email con un link per reimpostare la tua password.', Mage::helper('adminhtml')->escapeHtml($email)));
