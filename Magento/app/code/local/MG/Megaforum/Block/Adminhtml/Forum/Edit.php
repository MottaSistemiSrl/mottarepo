...
class MG_Megaforum_Block_Adminhtml_Forum_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		public function __construct()
		{

				parent::__construct();
				$this->_objectId = "forum_id";
		...
		public function getHeaderText()
		{
				if( Mage::registry("forum_data") && Mage::registry("forum_data")->getId() ){
				    ...
				    return Mage::helper("megaforum")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("forum_data")->getId()));
