...
class MG_Megaforum_Block_Adminhtml_Post_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		public function getHeaderText()
		{
				if( Mage::registry("post_data") && Mage::registry("post_data")->getId() ){
				    ...
				    return Mage::helper("megaforum")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("post_data")->getId()));
