...
class MG_Megaforum_Adminhtml_PostController extends Mage_Adminhtml_Controller_Action
{
		protected function _initAction()
		{
				$this->loadLayout()->_setActiveMenu("megaforum/post")->_addBreadcrumb(Mage::helper("adminhtml")->__("Post  Manager"),Mage::helper("adminhtml")->__("Post Manager"));
				return $this;
		}
		public function indexAction() 
		{
			    $this->_title($this->__("Megaforum"));
			    $this->_title($this->__("Manager Post"));
		...
		{			    
				...
				if ($model->getId()) {
					...
					$this->loadLayout();
					$this->_setActiveMenu("megaforum/post");
					$this->_addBreadcrumb(Mage::helper("adminhtml")->__("Post Manager"), Mage::helper("adminhtml")->__("Post Manager"));
					$this->_addBreadcrumb(Mage::helper("adminhtml")->__("Post Description"), Mage::helper("adminhtml")->__("Post Description"));
					$this->getLayout()->getBlock("head")->setCanLoadExtJs(true);
					$this->_addContent($this->getLayout()->createBlock("megaforum/adminhtml_post_edit"))->_addLeft($this->getLayout()->createBlock("megaforum/adminhtml_post_edit_tabs"));
					$this->renderLayout();
				} 
				else {
		...
		{
			$fileName   = 'post.csv';
			$grid       = $this->getLayout()->createBlock('megaforum/adminhtml_post_grid');
