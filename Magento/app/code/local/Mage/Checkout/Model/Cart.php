...
class Mage_Checkout_Model_Cart extends Varien_Object implements Mage_Checkout_Model_Cart_Interface
{
    ...
    public function addProduct($productInfo, $requestInfo=null)
    {
        ...
        //se il prodotto e' downloadable controllo che non sia già presente a carrello altrimenti
        // non lo aggiungo
        if($product->getTypeId()=='downloadable'){
            if($this->getQuote()->hasProductId($productId)){
                Mage::throwException('Prodotto già presente nel carrello');
                return;
            }
        }
