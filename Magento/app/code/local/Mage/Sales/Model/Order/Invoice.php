...
class Mage_Sales_Model_Order_Invoice extends Mage_Sales_Model_Abstract
{
    ...
    public function sendEmail($notifyCustomer = true, $comment = '')
    {
        ...
        //modifica sevenlike per togliere l'anno dalla mail di conferma ordine
        $currYear = date('Y');
        $incrementIdModified = str_replace('/' .$currYear,'',$this->getIncrementId());
        ...
        $mailer->setTemplateParams(array(
                ...
                'increment_id' => $incrementIdModified
            )
        );
        //fine modifica sevenlike
        $mailer->send();
