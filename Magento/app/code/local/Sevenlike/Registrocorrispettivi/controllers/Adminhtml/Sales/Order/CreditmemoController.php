...
class Sevenlike_Registrocorrispettivi_Adminhtml_Sales_Order_CreditmemoController extends Mage_Adminhtml_Sales_Order_CreditmemoController
{
    ...
    public function saveAction()
    {
        ...
        try {
            ...
            if ($creditmemo) {
                $creditmemo->setAddCorrispettivo($data['add_corrispettivo']);
