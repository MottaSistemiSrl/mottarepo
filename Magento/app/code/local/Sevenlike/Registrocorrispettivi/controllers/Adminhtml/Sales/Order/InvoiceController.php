...
class SevenLike_Registrocorrispettivi_Adminhtml_Sales_Order_InvoiceController extends Mage_Adminhtml_Sales_Order_InvoiceController
{
    public function saveAction()
    {
        ...
        try {
            ...
            if ($invoice) {
                $invoice->setAddCorrispettivo($data['add_corrispettivo']);
            ...
            $this->_getSession()->addError($this->__('Unable to save the invoice.') . $e->getMessage());
            Mage::logException($e);
        }
        $this->_redirect('*/*/new', array('order_id' => $orderId));
    }
